...
namespace Bot_Dofus_1._29._1.Otros.Game.Personaje.Inventario
{
	...
	{
		// Token: 0x0600040E RID: 1038 RVA: 0x0000DAC2 File Offset: 0x0000BCC2
		public static List<InventarioPosiciones> get_Posibles_Posiciones(int tipo_objeto)
		{
			if (!InventarioUtiles.possibles_posiciones.ContainsKey(tipo_objeto))
			{
				return null;
			}
			return InventarioUtiles.possibles_posiciones[tipo_objeto];
		}

		// Token: 0x0600040F RID: 1039 RVA: 0x0000DAE0 File Offset: 0x0000BCE0
		public static TipoObjetosInventario get_Objetos_Inventario(byte tipo)
		{
			...
			case 22:
			case 83:
				return TipoObjetosInventario.EQUIPEMENT;
			case 12:
			case 13:
			case 42:
				return TipoObjetosInventario.DIVERS;
			case 15:
			case 34:
			case 35:
			case 36:
			...
			case 24:
				return TipoObjetosInventario.OBJETS_QUETES;
			case 33:
				return TipoObjetosInventario.DIVERS;
			case 85:
			case 86:
		...
		{
			{
				...
				{
					InventarioPosiciones.AMULETTTE
				}
			},
			{
				2,
			...
			},
			{
				...
				new List<InventarioPosiciones>
				{
					InventarioPosiciones.ANNEAU_GAUCHE,
					InventarioPosiciones.ANNEAU_DROIT
				}
			},
			{
				10,
